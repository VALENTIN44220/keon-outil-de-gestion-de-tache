...
INSERT INTO public.be_tjm_fonctions (fonction, taux_horaire, description) VALUES
  ('Apprenti',                        10.20953655, 'Salaire moyen horaire - Apprenti'),
  ('Assistante',                       33.3497891,  'Salaire moyen horaire - Assistante'),
  ('Assistante commerciale',           33.10566429, 'Salaire moyen horaire - Assistante commerciale'),
  ('Chargé d''affaire senior',         51.0234481,  'Salaire moyen horaire - Chargé d''affaire senior'),
  ('Chargé d''Affaires',              69.465289,   'Salaire moyen horaire - Chargé d''Affaires'),
  ('Chargé de partenariats',          60.34618609, 'Salaire moyen horaire - Chargé de partenariats'),
  ('Chef de projet junior',           43.46062419, 'Salaire moyen horaire - Chef de projet junior'),
  ('Chef de projet senior',           65.59457067, 'Salaire moyen horaire - Chef de projet senior'),
  ('CODIR',                           92.73381159, 'Salaire moyen horaire - CODIR'),
  ('Conducteur de travaux',           42.43141412, 'Salaire moyen horaire - Conducteur de travaux'),
  ('Dessinateur Projeteur',           36.52120773, 'Salaire moyen horaire - Dessinateur Projeteur'),
  ('Finance',                         37.98683232, 'Salaire moyen horaire - Finance'),
  ('Fonction support',                42.51712162, 'Salaire moyen horaire - Fonction support'),
  ('Ingénieur',                       43.24091838, 'Salaire moyen horaire - Ingénieur'),
  ('Ingénieur Automatisme',           33.3881158,  'Salaire moyen horaire - Ingénieur Automatisme'),
  ('Ingénieur BE',                    38.92756512, 'Salaire moyen horaire - Ingénieur BE'),
  ('Ingénieur d''étude d''exécution', 40.71929516, 'Salaire moyen horaire - Ingénieur d''étude d''exécution'),
  ('Ingénieur mise en route',         40.65965046, 'Salaire moyen horaire - Ingénieur mise en route'),
  ('Ingénieur R&D',                   43.54010034, 'Salaire moyen horaire - Ingénieur R&D'),
  ('Ingénieur réalisation',           42.6265925,  'Salaire moyen horaire - Ingénieur réalisation'),
  ('IT',                              38.04964306, 'Salaire moyen horaire - IT'),
  ('Manager',                         52.40904116, 'Salaire moyen horaire - Manager'),
  ('MKT',                             35.35676011, 'Salaire moyen horaire - MKT'),
  ('Responsable',                     69.48352946, 'Salaire moyen horaire - Responsable'),
  ('Responsable régional',            71.37320688, 'Salaire moyen horaire - Responsable régional'),
  ('Responsable technique',           39.96205563, 'Salaire moyen horaire - Responsable technique'),
  ('RH',                              36.81451708, 'Salaire moyen horaire - RH'),
  ('Services partagés',               31.95062623, 'Salaire moyen horaire - Services partagés'),
  ('Support',                         38.91847208, 'Salaire moyen horaire - Support'),
  ('Technicien',                      50.83593869, 'Salaire moyen horaire - Technicien'),
  ('Technicien spécialisé',           26.13369441, 'Salaire moyen horaire - Technicien spécialisé'),
  ('Technico-commercial',             45.06189679, 'Salaire moyen horaire - Technico-commercial'),
  ('VIE',                             20.65159692, 'Salaire moyen horaire - VIE')
