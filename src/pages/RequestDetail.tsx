      ...
      <div className="flex-1 flex overflow-hidden">
        <main className="flex-1 overflow-y-auto min-w-0 bg-slate-100">
          <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-4 pb-12">
            ...
            {/* HERO CARD                                          */}
            {/* ─────────────────────────────────────────────────── */}
            <div className="relative overflow-hidden rounded-2xl border-2 border-blue-200 bg-gradient-to-br from-white via-blue-50/40 to-violet-50/30 shadow-md">
              ...
              <TabsContent value="steps" className="mt-5 space-y-5">
                {childTasks.length === 0 ? (
                  <Card className="border-dashed border-2 border-blue-300 bg-blue-50">
                    <CardContent className="p-16 text-center text-sm text-blue-700/70">
                      <FileText className="h-10 w-10 mx-auto opacity-50 mb-3 text-blue-500" />
                      Aucune étape pour cette demande.
                    </CardContent>
                  </Card>
                ) : subProcessGroups.length === 0 ? (
                  <Card className="overflow-hidden shadow-sm">
                    <CardHeader className="pb-3 border-b-2 border-blue-200 bg-gradient-to-r from-blue-100 to-violet-100">
