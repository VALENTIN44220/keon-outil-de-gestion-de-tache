...
export const STATUS_TRANSITIONS: Record<TaskStatus, TaskStatus[]> = {
  ...
  'pending_validation_1': ['pending_validation_2', 'validated', 'refused', 'in-progress', 'review', 'cancelled'],
  'pending_validation_2': ['validated', 'refused', 'in-progress', 'review', 'cancelled'],
